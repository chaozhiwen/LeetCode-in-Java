...
class Main{
	public static void main(String[] args){
		...
		g2.right=g5;
		g3.right=g6;
		System.out.println(s.findBottomLeftValue(g1));
		...
		q2.left=q4;
		q3.right=q5;
		System.out.println(s.findBottomLeftValue(q1));
		...
		w1.left=w2;
		w2.left=w3;
		System.out.println(s.findBottomLeftValue(w1));
		...
		a1.right=a3;
		a3.right=a4;
		System.out.println(s.findBottomLeftValue(a1));
		
		
		/*       1              */
		TreeNode b1=new TreeNode(1);
		TreeNode b2=new TreeNode(2);
		System.out.println(s.findBottomLeftValue(b1));
