...
class Main{
	public static void main(String[] args){
		...
		List<List<Integer>> print1=s.levelOrder(t1);
		for(int i=0;i<print1.size();i++){
			for(int j=0;j<print1.get(i).size();j++)
				System.out.print(print1.get(i).get(j)+" ");
			System.out.println();
		}
		System.out.println("*****");
		...
		List<List<Integer>> print2=s.levelOrder(r1);
		for(int i=0;i<print2.size();i++){
			for(int j=0;j<print2.get(i).size();j++)
				System.out.print(print2.get(i).get(j)+" ");
			System.out.println();
		}
		System.out.println("*****");
		...
		List<List<Integer>> print3=s.levelOrder(n1);
		for(int i=0;i<print3.size();i++){
			for(int j=0;j<print3.get(i).size();j++)
				System.out.print(print3.get(i).get(j)+" ");
			System.out.println();
		}
		System.out.println("*****");
