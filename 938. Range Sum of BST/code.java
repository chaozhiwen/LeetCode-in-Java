...
class Main{
	public static void main(String[] args){
		...
		System.out.println(s.rangeSumBST(t1,0,30));
		System.out.println(s.rangeSumBST(t1,50,120));
		System.out.println(s.rangeSumBST(t1,41,48));
		System.out.println(s.rangeSumBST(t1,140,145));
		System.out.println(s.rangeSumBST(t1,146,200));
	}
}
